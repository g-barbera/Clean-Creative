...
public class ItemGroupsMixin {
    ...
    private static EntryCollector modifier1(EntryCollector entryCollector) {
        return (displayContext, entries) -> Stream.of(
            ...
            STRIPPED_SPRUCE_LOG, STRIPPED_SPRUCE_WOOD, SPRUCE_SLAB, SPRUCE_FENCE,
            ...
            STRIPPED_BIRCH_LOG, STRIPPED_BIRCH_WOOD, BIRCH_SLAB, BIRCH_FENCE,
            ...
            STRIPPED_JUNGLE_LOG, STRIPPED_JUNGLE_WOOD, JUNGLE_SLAB, JUNGLE_FENCE,
            ...
            NETHER_BRICK_FENCE, COBBLED_DEEPSLATE_WALL, POLISHED_DEEPSLATE_WALL, DEEPSLATE_BRICK_WALL, DEEPSLATE_TILE_WALL,
            STRIPPED_ACACIA_LOG, STRIPPED_ACACIA_WOOD, ACACIA_SLAB, ACACIA_FENCE,
            ...
            NETHER_BRICK_STAIRS, RED_NETHER_BRICK_STAIRS, BLACKSTONE_STAIRS, POLISHED_BLACKSTONE_STAIRS, POLISHED_BLACKSTONE_BRICK_STAIRS,
            STRIPPED_DARK_OAK_LOG, STRIPPED_DARK_OAK_WOOD, DARK_OAK_SLAB, DARK_OAK_FENCE,
            NETHER_BRICK_SLAB, RED_NETHER_BRICK_SLAB, BLACKSTONE_SLAB, POLISHED_BLACKSTONE_SLAB, POLISHED_BLACKSTONE_BRICK_SLAB,
            MANGROVE_LOG, MANGROVE_WOOD, MANGROVE_PLANKS, MANGROVE_STAIRS,
            NETHER_BRICK_WALL, RED_NETHER_BRICK_WALL, BLACKSTONE_WALL, POLISHED_BLACKSTONE_WALL, POLISHED_BLACKSTONE_BRICK_WALL,
            STRIPPED_MANGROVE_LOG, STRIPPED_MANGROVE_WOOD, MANGROVE_SLAB, MANGROVE_FENCE,
            CRACKED_NETHER_BRICKS, CHISELED_NETHER_BRICKS, GILDED_BLACKSTONE, CHISELED_POLISHED_BLACKSTONE, CRACKED_POLISHED_BLACKSTONE_BRICKS,
            CHERRY_LOG, CHERRY_WOOD, CHERRY_PLANKS, CHERRY_STAIRS,
            NETHERRACK, PACKED_MUD, SMOOTH_BASALT, BASALT, POLISHED_BASALT,
            STRIPPED_CHERRY_LOG, STRIPPED_CHERRY_WOOD, CHERRY_SLAB, CHERRY_FENCE,
            BRICKS, MUD_BRICKS, GRANITE, DIORITE, ANDESITE,
            WARPED_STEM, WARPED_HYPHAE, WARPED_PLANKS, WARPED_STAIRS,
            BRICK_STAIRS, MUD_BRICK_STAIRS, GRANITE_STAIRS, DIORITE_STAIRS, ANDESITE_STAIRS,
            STRIPPED_WARPED_STEM, STRIPPED_WARPED_HYPHAE, WARPED_SLAB, WARPED_FENCE,
            BRICK_SLAB, MUD_BRICK_SLAB, GRANITE_SLAB, DIORITE_SLAB, ANDESITE_SLAB,
            CRIMSON_STEM, CRIMSON_HYPHAE, CRIMSON_PLANKS, CRIMSON_STAIRS,
            BRICK_WALL, MUD_BRICK_WALL, GRANITE_WALL, DIORITE_WALL, ANDESITE_WALL,
            STRIPPED_CRIMSON_STEM, STRIPPED_CRIMSON_HYPHAE, CRIMSON_SLAB, CRIMSON_FENCE,
            END_STONE_BRICKS, PURPUR_BLOCK, POLISHED_GRANITE, POLISHED_DIORITE, POLISHED_ANDESITE,
            BAMBOO_BLOCK, BAMBOO_PLANKS, BAMBOO_STAIRS, BAMBOO_SLAB,
            END_STONE_BRICK_STAIRS, PURPUR_STAIRS, POLISHED_GRANITE_STAIRS, POLISHED_DIORITE_STAIRS, POLISHED_ANDESITE_STAIRS,
            STRIPPED_BAMBOO_BLOCK, BAMBOO_MOSAIC, BAMBOO_MOSAIC_STAIRS, BAMBOO_MOSAIC_SLAB,
            END_STONE_BRICK_SLAB, PURPUR_SLAB, POLISHED_GRANITE_SLAB, POLISHED_DIORITE_SLAB, POLISHED_ANDESITE_SLAB,
            BAMBOO_FENCE, SANDSTONE_WALL, RED_SANDSTONE_WALL, END_STONE, END_STONE_BRICK_WALL,
            PURPUR_PILLAR, PRISMARINE, PRISMARINE_BRICKS, DARK_PRISMARINE,
            SANDSTONE, SANDSTONE_STAIRS, SANDSTONE_SLAB, SMOOTH_SANDSTONE, SMOOTH_SANDSTONE_STAIRS,
            SMOOTH_SANDSTONE_SLAB, PRISMARINE_STAIRS, PRISMARINE_BRICK_STAIRS, DARK_PRISMARINE_STAIRS,
            RED_SANDSTONE, RED_SANDSTONE_STAIRS, RED_SANDSTONE_SLAB, SMOOTH_RED_SANDSTONE, SMOOTH_RED_SANDSTONE_STAIRS,
            SMOOTH_RED_SANDSTONE_SLAB, PRISMARINE_SLAB, PRISMARINE_BRICK_SLAB, DARK_PRISMARINE_SLAB,
            CUT_SANDSTONE, CUT_RED_SANDSTONE, CHISELED_SANDSTONE, CHISELED_RED_SANDSTONE,
            CUT_SANDSTONE_SLAB, CUT_RED_SANDSTONE_SLAB, PRISMARINE_WALL, SEA_LANTERN, AMETHYST_BLOCK,
            ...
            WAXED_COPPER_BLOCK, WAXED_CUT_COPPER, WAXED_CUT_COPPER_STAIRS, WAXED_CUT_COPPER_SLAB, IRON_BARS,
            EXPOSED_COPPER, EXPOSED_CUT_COPPER, EXPOSED_CUT_COPPER_STAIRS, EXPOSED_CUT_COPPER_SLAB,
            WAXED_EXPOSED_COPPER, WAXED_EXPOSED_CUT_COPPER, WAXED_EXPOSED_CUT_COPPER_STAIRS, WAXED_EXPOSED_CUT_COPPER_SLAB, CHAIN,
            WEATHERED_COPPER, WEATHERED_CUT_COPPER, WEATHERED_CUT_COPPER_STAIRS, WEATHERED_CUT_COPPER_SLAB,
            WAXED_WEATHERED_COPPER, WAXED_WEATHERED_CUT_COPPER, WAXED_WEATHERED_CUT_COPPER_STAIRS, WAXED_WEATHERED_CUT_COPPER_SLAB, COAL_BLOCK,
            OXIDIZED_COPPER, OXIDIZED_CUT_COPPER, OXIDIZED_CUT_COPPER_STAIRS, OXIDIZED_CUT_COPPER_SLAB,
            WAXED_OXIDIZED_COPPER, WAXED_OXIDIZED_CUT_COPPER, WAXED_OXIDIZED_CUT_COPPER_STAIRS, WAXED_OXIDIZED_CUT_COPPER_SLAB, IRON_BLOCK,
            GOLD_BLOCK, REDSTONE_BLOCK, EMERALD_BLOCK, LAPIS_BLOCK, DIAMOND_BLOCK, NETHERITE_BLOCK
        ).forEach(entries::add);
    }
    ...
    private static EntryCollector modifier3(EntryCollector entryCollector) {
        return (displayContext, entries) -> Stream.of(
            ...
            OAK_LOG, SPRUCE_LOG, BIRCH_LOG, JUNGLE_LOG, CRIMSON_STEM, AZALEA, AZALEA_LEAVES, MANGROVE_ROOTS, AMETHYST_BLOCK,
            ACACIA_LOG, DARK_OAK_LOG, MANGROVE_LOG, CHERRY_LOG, WARPED_STEM, FLOWERING_AZALEA, FLOWERING_AZALEA_LEAVES, MUDDY_MANGROVE_ROOTS, BUDDING_AMETHYST,
            OAK_SAPLING, SPRUCE_SAPLING, BIRCH_SAPLING, JUNGLE_SAPLING, CRIMSON_FUNGUS, WEEPING_VINES, CRIMSON_ROOTS, SMALL_AMETHYST_BUD, MEDIUM_AMETHYST_BUD,
            ACACIA_SAPLING, DARK_OAK_SAPLING, MANGROVE_PROPAGULE, CHERRY_SAPLING, WARPED_FUNGUS, TWISTING_VINES, WARPED_ROOTS, LARGE_AMETHYST_BUD, AMETHYST_CLUSTER,
            OAK_LEAVES, SPRUCE_LEAVES, BIRCH_LEAVES, JUNGLE_LEAVES, NETHER_WART_BLOCK, SHROOMLIGHT, SNIFFER_EGG, PITCHER_PLANT, TORCHFLOWER,
            ACACIA_LEAVES, DARK_OAK_LEAVES, MANGROVE_LEAVES, CHERRY_LEAVES, WARPED_WART_BLOCK, MUSHROOM_STEM, PINK_PETALS, PITCHER_POD, TORCHFLOWER_SEEDS,
    ...
    private static EntryCollector modifier4(EntryCollector entryCollector) {
        return (displayContext, entries) -> Stream.of(
            ...
            if (item == OAK_SIGN) addPaintings(
                entries, displayContext.lookup().getWrapperOrThrow(RegistryKeys.PAINTING_VARIANT),
                entry -> entry.isIn(PLACEABLE), StackVisibility.PARENT_AND_SEARCH_TABS
            );
    ...
    private static EntryCollector modifier6(EntryCollector entryCollector) {
        return (displayContext, entries) -> {
            var iter = displayContext.lookup().getWrapperOrThrow(RegistryKeys.INSTRUMENT).getOrThrow(GOAT_HORNS)
                .stream().map(
            ...
            for (var item: new Item[]{
                ...
                var stack = item == GOAT_HORN? iter.next(): new ItemStack(item);
    ...
    private static EntryCollector modifier8(EntryCollector entryCollector) {
        return (displayContext, entries) -> {
            ...
            var iter = SuspiciousStewIngredient.getAll().stream().map(ingredient -> {
                var itemStack = new ItemStack(SUSPICIOUS_STEW);
                SuspiciousStewItem.addEffectToStew(itemStack, ingredient.getEffectInStew(), ingredient.getEffectInStewDuration());
                return itemStack;
            }).iterator();
//            SuspiciousStewIngredient.getAll().forEach(ingredient -> {
//                var itemStack = new ItemStack(SUSPICIOUS_STEW);
//                SuspiciousStewItem.addEffectToStew(itemStack, ingredient.getEffectInStew(), ingredient.getEffectInStewDuration());
//                set.add(itemStack);
//            });
//            var iter = set.iterator();
            ...
            ).map(item -> item == SUSPICIOUS_STEW ? iter.next() : new ItemStack(item)
            ).forEach(entries::add);
            var registryWrapper = displayContext.lookup().getWrapperOrThrow(RegistryKeys.POTION);
    ...
    private static EntryCollector modifier9(EntryCollector entryCollector) {
        return (displayContext, entries) -> {
            Stream.of(
                ...
                NETHERITE_UPGRADE_SMITHING_TEMPLATE, SNOUT_ARMOR_TRIM_SMITHING_TEMPLATE, RIB_ARMOR_TRIM_SMITHING_TEMPLATE,
                ANGLER_POTTERY_SHARD, ARCHER_POTTERY_SHARD, ARMS_UP_POTTERY_SHARD, BLADE_POTTERY_SHARD, BREWER_POTTERY_SHARD,
                SENTRY_ARMOR_TRIM_SMITHING_TEMPLATE, VEX_ARMOR_TRIM_SMITHING_TEMPLATE, DUNE_ARMOR_TRIM_SMITHING_TEMPLATE, WILD_ARMOR_TRIM_SMITHING_TEMPLATE,
                BURN_POTTERY_SHARD, DANGER_POTTERY_SHARD, EXPLORER_POTTERY_SHARD, FRIEND_POTTERY_SHARD, HEART_POTTERY_SHARD,
                COAST_ARMOR_TRIM_SMITHING_TEMPLATE, TIDE_ARMOR_TRIM_SMITHING_TEMPLATE, EYE_ARMOR_TRIM_SMITHING_TEMPLATE, SPIRE_ARMOR_TRIM_SMITHING_TEMPLATE,
                HEARTBREAK_POTTERY_SHARD, HOWL_POTTERY_SHARD, MINER_POTTERY_SHARD, MOURNER_POTTERY_SHARD, PLENTY_POTTERY_SHARD,
                WAYFINDER_ARMOR_TRIM_SMITHING_TEMPLATE, RAISER_ARMOR_TRIM_SMITHING_TEMPLATE, SHAPER_ARMOR_TRIM_SMITHING_TEMPLATE, HOST_ARMOR_TRIM_SMITHING_TEMPLATE,
                PRIZE_POTTERY_SHARD, SHEAF_POTTERY_SHARD, SHELTER_POTTERY_SHARD, SKULL_POTTERY_SHARD, SNORT_POTTERY_SHARD,
            ...
            var set = allOf(EnchantmentTarget.class);
            var registryWrapper = displayContext.lookup().getWrapperOrThrow(RegistryKeys.ENCHANTMENT);
            registryWrapper.streamEntries().map(RegistryEntry::value)
                .filter(enchantment -> set.contains(enchantment.target))
                .map(enchantment -> EnchantedBookItem.forEnchantment(new EnchantmentLevelEntry(enchantment, enchantment.getMaxLevel())))
                .forEach(stack -> entries.add(stack, StackVisibility.PARENT_TAB_ONLY));
            registryWrapper.streamEntries().map(RegistryEntry::value)
                .filter(enchantment -> set.contains(enchantment.target))
                .flatMap(enchantment -> rangeClosed(enchantment.getMinLevel(), enchantment.getMaxLevel()).mapToObj(level -> EnchantedBookItem.forEnchantment(new EnchantmentLevelEntry(enchantment, level))))
