 ...
 * public static final ItemGroup BUILDING_BLOCKS = ItemGroup
 *     .create(ItemGroup.Row.TOP, 0)
 *     .entries((displayContext, entries) -> {...})
 *     .build();
 *
 * // How the method is injected; note that the object passed
 * // into entries is passed into the modifier method first
 * public static final ItemGroup BUILDING_BLOCKS = ItemGroup
 *     .create(ItemGroup.Row.TOP, 0)
...
//
    ...
    private static EntryCollector modifier6(EntryCollector entryCollector) {
        return (displayContext, entries) -> {
            Item[] items = {
                ...
                BRUSH, FISHING_ROD, CARROT_ON_A_STICK, WARPED_FUNGUS_ON_A_STICK,MUSIC_DISC_13, MUSIC_DISC_CAT, MUSIC_DISC_BLOCKS, MUSIC_DISC_CHIRP, MUSIC_DISC_FAR,
                GOAT_HORN, GOAT_HORN, GOAT_HORN, GOAT_HORN, MUSIC_DISC_MALL, MUSIC_DISC_MELLOHI, MUSIC_DISC_STAL, MUSIC_DISC_STRAD, MUSIC_DISC_WARD,
    ...
    private static EntryCollector modifier8(EntryCollector entryCollector) {
        return (displayContext, entries) -> {
            ...
            for (SuspiciousStewIngredient ingredient : list) {
            ...
            for (Item item: items) {
                stack = new ItemStack(item);
                entries.add(item == SUSPICIOUS_STEW? iter.next(): stack);
            }
            displayContext.lookup().getOptionalWrapper(RegistryKeys.POTION).ifPresent(registryWrapper -> {
    ...
    private static EntryCollector modifier9(EntryCollector entryCollector) {
        return (displayContext, entries) -> {
            Item[] items = {
                ...
                ANGLER_POTTERY_SHARD, ARCHER_POTTERY_SHARD, ARMS_UP_POTTERY_SHARD, BLADE_POTTERY_SHARD,
                BREWER_POTTERY_SHARD, BURN_POTTERY_SHARD, DANGER_POTTERY_SHARD, EXPLORER_POTTERY_SHARD,
                FRIEND_POTTERY_SHARD, HEART_POTTERY_SHARD, HEARTBREAK_POTTERY_SHARD, HOWL_POTTERY_SHARD,
                MINER_POTTERY_SHARD, MOURNER_POTTERY_SHARD, PLENTY_POTTERY_SHARD, PRIZE_POTTERY_SHARD,
                SHEAF_POTTERY_SHARD, SHELTER_POTTERY_SHARD, SKULL_POTTERY_SHARD, SNORT_POTTERY_SHARD,
                NETHERITE_UPGRADE_SMITHING_TEMPLATE, SENTRY_ARMOR_TRIM_SMITHING_TEMPLATE, VEX_ARMOR_TRIM_SMITHING_TEMPLATE,
                WILD_ARMOR_TRIM_SMITHING_TEMPLATE, COAST_ARMOR_TRIM_SMITHING_TEMPLATE, DUNE_ARMOR_TRIM_SMITHING_TEMPLATE,
                WAYFINDER_ARMOR_TRIM_SMITHING_TEMPLATE, RAISER_ARMOR_TRIM_SMITHING_TEMPLATE, SHAPER_ARMOR_TRIM_SMITHING_TEMPLATE,
                HOST_ARMOR_TRIM_SMITHING_TEMPLATE, WARD_ARMOR_TRIM_SMITHING_TEMPLATE, SILENCE_ARMOR_TRIM_SMITHING_TEMPLATE,
                TIDE_ARMOR_TRIM_SMITHING_TEMPLATE, SNOUT_ARMOR_TRIM_SMITHING_TEMPLATE, RIB_ARMOR_TRIM_SMITHING_TEMPLATE,
                EYE_ARMOR_TRIM_SMITHING_TEMPLATE, SPIRE_ARMOR_TRIM_SMITHING_TEMPLATE,
